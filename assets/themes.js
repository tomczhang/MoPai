...
<p style="font-size:10px;color:${N.aux};letter-spacing:1px;margin:0;">${leaf('THANKS FOR READING')}</p>
  ...
  // 石墨黑：克制的编辑部风格，适合观点、评论与品牌内容
  const graphite = makeMagazineTheme({
    id: 'graphite',
    name: '石墨黑',
    main: '#27272A',
    sub: '#52525B',
  ...
  // 赤诚红：更有力量的叙事风格，适合深度观点与复盘
  const chicheng = makeMagazineTheme({
    id: 'chicheng',
    name: '赤诚红',
    main: '#B4232F',
    sub: '#D13B47',
  ...
  return {
    themes: { lizhi, moyu, graphite, chicheng },
    order: ['lizhi', 'moyu', 'graphite', 'chicheng'],
    helpers: { leaf, FILL },
  };
})();
